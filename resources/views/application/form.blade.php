          ...
          <div class="card-text">
            <form class="form" action="{{route('application.create-form')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control {{ $errors->has('age') ? 'border-danger' : '' }}" name="age"
                  id="age" placeholder="Enter your age">
                <small id="ageHelp" class="form-text {{ $errors->has('age') ? 'text-danger' : 'text-muted' }}">You must
                  be over 15 to join.</small>
              </div>
              <div class="form-group">
                <label for="dob">Date of Birth</label>
                <input class="form-control {{ $errors->has('dob') ? 'border-danger' : '' }}" type="date" id="dob"
              ...
              <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discord') ? 'border-danger' : '' }}" type="text"
              ...
              <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('join_reason') ? 'border-danger' : '' }}" id="join_reason"
                  rows="3" name="join_reason"></textarea>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('previous_community') ? 'border-danger' : '' }}"
