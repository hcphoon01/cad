      ...
      <div class="card flex-grow-1">
                ...
                <form id="announcementEdit" method="post" action={{route('admin.create-announcement')}}>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <textarea class="form-control" name="body" rows="10" placeholder="Enter the content"></textarea>
                    </div>
        ...
        <div class="card-body">
          <div class="row px-3 justify-content-between">
            ...
            <div>
              @can('create announcements')
              <form action="{{ route('admin.delete-announcement', ['id' => $announcement->id]) }}" method="post"
                class="is-hidden">
                @csrf
                @method('DELETE')
    ...
    <div class="col-6 col-md-4">
      <div class="card flex-grow-1">
        <h2 class="card-header">
          Events
          @can('manage events')
          <button type="button" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#editEvent">
            Edit
          </button>
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#bookOnModal">Book
            On</button>
          <div class="modal fade" id="bookOnModal" tabindex="-1" role="dialog" aria-labelledby="bookOnModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
