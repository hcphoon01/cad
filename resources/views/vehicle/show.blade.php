        ...
        <form action="{{route('vehicle.update', ['id' => $vehicle->id])}}" method="POST" id="vehicle">
            ...
            <div class="form-group">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="make" id="make"
                                class="form-control {{ $errors->has('make') ? 'border-danger' : '' }}" required
                                placeholder="Ford" value="{{$vehicle->make}}" />
                            @if($errors->has('make'))
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="model" id="model"
                                class="form-control {{ $errors->has('model') ? 'border-danger' : '' }}" required
                                placeholder="Focus" value="{{$vehicle->model}}" />
                            @if($errors->has('model'))
                            <p class="help text-danger">
                                {{ $errors->first('model') }}
                            </p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="vrm" id="vrm"
                        class="form-control {{ $errors->has('vrm') ? 'border-danger' : '' }}" required
                        value="{{$vehicle->vrm}}" />
                    @if($errors->has('vrm'))
                    <p class="help text-danger">
                        {{ $errors->first('vrm') }}
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="class" id="class"
                        class="form-control {{ $errors->has('class') ? 'border-danger' : '' }}" required
                        placeholder="Marked IRV" value="{{$vehicle->class}}" />
                    @if($errors->has('class'))
                    <p class="help text-danger">
                        {{ $errors->first('class') }}
                    </p>
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-secondary btn-sm mt-1" id="reset-date">Clear Date</button>
