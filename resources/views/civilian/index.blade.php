...
<div class="container">
  <div class="modal fade" tabindex="-1" role="dialog" id="createCiv">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <form action="{{route('civilian.person')}}" method="POST">
        @csrf
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="createVehicle">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <form action="{{route('civilian.vehicle')}}" method="POST">
        @csrf
        <div class="modal-content">
          <div class="modal-header">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="createCad">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <form action="{{route('civilian.cad')}}" method="POST">
        @csrf
        <div class="modal-content">
          <div class="modal-header">
  ...
  <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" id="civilian-tab" data-toggle="tab" href="#civilian" role="tab"
        aria-controls="civilian" aria-selected="true">Civilian</a>
    </li>
    <li class="nav-item">
  ...
  <div class="row mt-2">
    <div class="tab-content w-100">
      <div class="tab-pane fade show active" id="civilian" role="tabpanel" aria-labelledby="civilian-tab">
        <div class="row">
