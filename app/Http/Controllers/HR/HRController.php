...
class HRController extends Controller
{
  ...
  public function index()
  {
    ...
    $hrReview = Applicant::where('gc_review', true)->where('hr_review', false)->get();
    $interviews = Applicant::where('hr_review', true)->where('interview', false)->get();
  ...
  public function progress(Applicant $applicant)
  {
    ...
    if ($applicant->hr_review) {
      ...
      Mail::to($applicant->user->email)->queue(new InterviewInvite($applicant));
